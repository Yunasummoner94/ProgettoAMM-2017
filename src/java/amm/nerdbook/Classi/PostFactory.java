...
public class PostFactory {
    ...
    private PostFactory() {
        ...
        Post post1 = new Post();
        post1.setContent("Primo post. Contenuto poco utile");
        post1.setId(0);
        post1.setUser(utenteFactory.getUtenteById(0));
        
        Post post2 = new Post();
        post2.setContent("Immagini/jonsnowbaba.jpg");
        post2.setId(1);
        post2.setUser(utenteFactory.getUtenteById(0));
        post2.setPostType(Post.Type.IMAGE);
        
        Post post3 = new Post();
        post3.setContent("Altro post estremamente poco utile");
        post3.setId(2);
    ...
    public List getPostList(Utente ut) {
